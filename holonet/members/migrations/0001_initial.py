    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acknowledge_posts', models.BooleanField(help_text='When this member posts to a list, receive a acknowledgement.', default=False)),
                ('groups', models.ManyToManyField(to='auth.Group', verbose_name='groups', help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_query_name='user', related_name='user_set', blank=True)),
